...
```{r}
fit <- get(load("../rdas/deng_guo_blast_48_genes_k_3.rda"))
```
...
```{r}
fit_k4 <- get(load("../rdas/deng_guo_blast_48_genes_k_4.rda"))
```
...
```{r combined-visualization-nolegend, fig.height=4, fig.width=8}
cowplot::plot_grid(
  pca_plots_48genes + ggtitle("PCA") + theme(legend.position="none"),
  tsne_plots_48genes + ggtitle("t-SNE")  + theme(legend.position="none"),
  labels = c("(a)", "(b)"))
```


```{r combined-visualization-pluslegend, fig.height=4, fig.width=10}
cowplot::plot_grid(
