...
topics_theta_brain <- data.frame(fread("../external_data/GTEX_V6/admix_out_GTEX_V6/theta_cis_genes_brain.txt"))[,-1];

top_features <- ExtractTopFeatures(topics_theta_brain, top_features=100, method="poisson", options="max");
