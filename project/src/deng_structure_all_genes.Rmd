...
In this script, we perform the graded membership model on the dataset obtained from the study due to Deng \emph{et al}. Check the [paper](http://science.sciencemag.org/content/343/6167/193).
...
if(!dir.exists("../plots/deng_structure")) dir.create("../plots/deng_structure")
...
### Structure plots based on development phase 

The Structure plots clearly show cell phase effects

<img src='../plots/deng_structure/clus_2/struct_clus_2_dev_phase.png' style="width:350px;height:300px;">
<img src='../plots/deng_structure/clus_3/struct_clus_3_dev_phase.png' style="width:350px;height:300px;">
<img src='../plots/deng_structure/clus_4/struct_clus_4_dev_phase.png' style="width:350px;height:300px;">
<img src='../plots/deng_structure/clus_5/struct_clus_5_dev_phase.png' style="width:350px;height:300px;">
<img src='../plots/deng_structure/clus_6/struct_clus_6_dev_phase.png' style="width:350px;height:300px;">
<img src='../plots/deng_structure/clus_7/struct_clus_7_dev_phase.png' style="width:350px;height:300px;">

### Structure plots based on development phase + embryo

The Structure plots clearly show cell phase effects

<img src='../plots/deng_structure/clus_2/struct_clus_2_dev.phase_embryo.png' style="width:350px;height:300px;">
<img src='../plots/deng_structure/clus_3/struct_clus_3_dev.phase_embryo.png' style="width:350px;height:300px;">
<img src='../plots/deng_structure/clus_4/struct_clus_4_dev.phase_embryo.png' style="width:350px;height:300px;">
<img src='../plots/deng_structure/clus_5/struct_clus_5_dev.phase_embryo.png' style="width:350px;height:300px;">
<img src='../plots/deng_structure/clus_6/struct_clus_6_dev.phase_embryo.png' style="width:350px;height:300px;">
<img src='../plots/deng_structure/clus_7/struct_clus_7_dev.phase_embryo.png' style="width:350px;height:300px;">
