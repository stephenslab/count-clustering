...
#gom_model_fit <- get(load("../../../../Downloads/gtexv6fit.k.5.run3.rda"))
...
#gom_model_fit <- get(load("../../../../Downloads/gtexv6fit.k.10.rda"))
...
# omega_thin <- read.table("../../../../Downloads/omega_cis_genes_0_1.txt",
#                             header = TRUE, sep = " ",
#                             stringsAsFactors = FALSE)
