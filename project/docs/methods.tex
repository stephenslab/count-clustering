...
Our methods are implemented in an R package \textbf{CountClust}, available at \url{https://github.com/kkdey/CountClust}.
...
We thank Matt Taddy, Amos Tanay and Effi Kenigsberg for helpful discussions. We thank Po Yuan and John Blischak for helpful comments on a draft manuscript.}
