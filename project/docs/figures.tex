...
\begin{figure*}[ht]
\raggedleft
\includegraphics[height=7.5in, width=6.5in]{../plots/gtex-figures/gtex_02_28_16.pdf}
...
\begin{figure*}[ht]
\centering
\includegraphics[height=4in, width=5.5in]{../plots/jaitin-figures/jaitin-amplification-2016-02-27.pdf}
...
\begin{figure*}[ht]
\centering
\includegraphics[height=4in, width=5.5in]{../plots/deng-figures/deng-2016-02-27.pdf}
...
\end{figure*}
 ...
 \begin{figure*}[ht]
 \centering
\includegraphics[height=7.5in, width=6.5in]{../plots/gtex-figures/gtex2_02_28_16.pdf}
    \caption{Structure plot of all tissue samples in 2 runs of the GTEx version 4 data for for K=15 for the thinning parameters (a) $p_{thin}=0.01$ and (b) $p_{thin}=0.001$. The broad patterns in the two plots are largely similar and also closely corresponds to \textbf{Fig} ~\ref{fig:fig1} (a). }
 \label{fig:figS1}
    \end{figure*}
