...
\begin{figure*}[ht]
\centering
\includegraphics[height=6.5in, width=4.5in]{../plots/deng-figures/deng-main-v3.pdf}
...
structure of single-cell data may in some cases be better captured by a GoM model than by simple discrete clusters.}
\label{fig:fig4}
\end{figure*}
