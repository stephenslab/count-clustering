...
\textit{Cluster analysis and display of genome-wide expression patterns}.
PNAS, 1998; 95(25): 14863?14868

\bibitem{Erosheva2006}
Erosheva EA.
\textit{Latent class representation of the grade of membership model}.
...
\bibitem{Oshlack2010}
Oshlack A, Robinsom MD and Young MD.
\textit{From RNA-seq reads to differential expression results}
...
\textit{Capturing Heterogeneity in Gene Expression Studies by Surrogate Variable Analysis}
PLoS Genet 3(9): e161. doi:10.1371/journal.pgen.0030161

\bibitem{Stegle2012}
O. Stegle, L. Parts , M. Piipari, J. Winn and  R. Durbin
\textit{Using probabilistic estimation of expression residuals (PEER) to obtain increased power and interpretability of gene expression analyses.}
...
PERT: A   Method   for   Expression   Deconvolution   of   Human   Blood   Samples   from   Varied
 ...
 \bibitem{Hu2016}
 Hu JG, Shi LL, Chen YJ, Xie XM, Zhang N, Zhu AY, Zheng JS, Feng YF, Zhang C, Xi J and Lu HZ.
 ...
 Experimental Neurology 2016, 277, 190-201
 ...
 Int J Cardiol. 2013, 165(2), 314?321.
 
 \bibitem{Gong2006}
 Gong B, Cao Z, Zheng P, Vitolo OV, Liu S, Staniszewski A, Moolman D, Zhang H, Shelanski M and Arancio O.
 Ubiquitin Hydrolase Uch-L1 Rescues $\beta$-Amyloid-Induced Decreases in Synaptic Function and Contextual Memory
 Cell 2006, 126(4), 775-788
