...
\begin{table}[htp]
\begin{center}
\caption{GTEx V6 Brain cluster annotations} \label{tab:tab9}
...
\hline
 ...
 \multirow{3}{4em}{\small{cluster 2, yellow orange}} & \small{SNAP25} & \footnotesize{synaptosomal-associated protein, 25kDa}
