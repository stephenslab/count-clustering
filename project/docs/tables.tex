...
\hline
 \multirow{3}{4em}{\small{cluster 1, green}}  &  \small{Timd2} & \small{ T cell immunoglobulin and mucin domain containing 2} \\ 
 					      & \small{Isyna1} &  \small{myo-inositol 1-phosphate synthase A1} \\
					      & \small{Alppl2} & \small{alkaline phosphatase, placental-like 2} \\
\hline
 \multirow{3}{4em}{\small{cluster 2,  purple}} & \small{Upp1} & \small{uridine phosphorylase 1} \\ 					    & \small{Tdgf1} & \small{teratocarcinoma-derived growth factor 1} \\
 ...
 \multirow{3}{4em}{\small{cluster 3, orange}}  &  \small{Actb} & \small{actin, beta,  involved in cell motility, structure, and integrity}   \\ 
 					      & \small{Krt18} &  \small{keratin 18}  \\
					      & \small{Fabp3} & \small{fatty acid binding protein 3, muscle and heart} \\
 \hline
 \multirow{3}{4em}{\small{cluster 4, yellow}} & \small{Rtn2} & \small{reticulon 2 (Z-band associated protein)} \\ 					    & \small{Hsp90ab1} & \small{heat shock protein 90 alpha (cytosolic), class B member 1} \\
 ...
 \hline
 \multirow{3}{4em}{\small{cluster 5, blue}} & \small{Bcl2l10} & \small{Bcl2 like 10} \\ 			 								& \small{Tcl1} & \small{T cell lymphoma breakpoint 1} \\
					    & \small{E330034G19Rik}  & \small{RIKEN cDNA E330034G19 gene}  \\
 \hline
 \multirow{3}{4em}{\small{cluster 6, magenta}} & \small{Obox3} & \small{oocyte specific homeobox 3} \\ 					     				& \small{Btg4} & \small{B cell translocation gene 4} \\
