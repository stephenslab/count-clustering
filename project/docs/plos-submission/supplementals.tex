...
\begin{figure}[ht]
\centering
\includegraphics[height=7.5in, width=6.5in]{../plots/gtex-figures/gtex-multiple-ks-04-30-2016.pdf}
\end{figure}
\clearpage
 ...
 \begin{figure}[ht]
    \centering    
     \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=2.5in]{../plots/hierarchical_separation_thinned_0_01.png}
