...
kept the result with the highest log-likelihood. Figure \ref{fig:fig1a}(a)) shows the Structure plot for $K=20$, with results for other $K$ in Supplementary Figure \ref{}.
(See also \textbf{Supplementary Figure 1 \url{http://stephenslab.github.io/count-clustering/project/src/tissues_tSNE_2.html}} for 
an alternative visualization using a 2-dimensional projection with t-SNE \cite{Maaten2008}, \cite{Maaten2014}.)
