...
in $86 \%$ of comparisons, compared with $39 \%$ for the distance-based method (Fig~\ref{fig:fig2}). This presumably reflects the general tendency for model-based
